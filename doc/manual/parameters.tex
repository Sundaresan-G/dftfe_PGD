...
{\it Possible values:} An integer $n$ such that $0\leq n \leq 1$
\item {\it Parameter name:} {\tt TOTAL MAGNETIZATION}
\phantomsection\label{parameters:DFT functional parameters/TOTAL MAGNETIZATION}
\label{parameters:DFT_20functional_20parameters/TOTAL_20MAGNETIZATION}


\index[prmindex]{TOTAL MAGNETIZATION}
\index[prmindexfull]{DFT functional parameters!TOTAL MAGNETIZATION}
{\it Value:} 0.0
...
{\it Description:} [Standard] Total magnetization to be used for constrained spin-polarized DFT calculations (must be between -1.0 and +1.0). Corresponding magnetization per simulation domain will be (TOTAL MAGNETIZATION x Number of electrons) a.u. 


{\it Possible values:} A floating point number $v$ such that $-1.0 \leq v \leq 1.0$
\end{itemize}
...
\phantomsection\label{parameters:Hubbard Parameters/HUBBARD PARAMETERS FILE}
\label{parameters:Hubbard/HUBBARD_PARAMETERS_FILE}
\index[prmindex]{HUBBARD PARAMETERS FILE}
\index[prmindexfull]{Hubbard Parameters!HUBBARD PARAMETERS FILE} \\
{\it Value:} \\
{\it Default:}\\
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt MESH SIZES FILE}
\phantomsection\label{parameters:Finite element mesh parameters/Auto mesh generation parameters/MESH SIZES FILE}
\label{parameters:Finite_20element_20mesh_20parameters/Auto_20mesh_20generation_20parameters/MESH_20SIZES_20FILE}


\index[prmindex]{MESH SIZES FILE}
\index[prmindexfull]{Finite element mesh parameters!Auto mesh generation parameters!MESH SIZES FILE}
{\it Value:}
...
{\it Description:} [Developer] Use mesh sizes from this file.
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt DOS SMEAR TEMPERATURE}
\phantomsection\label{parameters:Post_2dprocessing Options/DOS SMEAR TEMPERATURE}
\label{parameters:Post_2dprocessing_20Options/DOS_20SMEAR_20TEMPERATURE}


\index[prmindex]{DOS SMEAR TEMPERATURE}
\index[prmindexfull]{Post-processing Options!DOS SMEAR TEMPERATURE}
{\it Value:} 500.0
...
{\it Description:}[Standard] Gaussian smearing temperature (in K) for DOS, PDOS and LDOS calculations.

{\it Possible values:} A floating point value
\item {\it Parameter name:} {\tt DELTA ENERGY}
\phantomsection\label{parameters:Post_2dprocessing Options/DELTA ENERGY}
\label{parameters:Post_2dprocessing_20Options/DELTA_20ENERGY}


\index[prmindex]{DELTA ENERGY}
\index[prmindexfull]{Post-processing Options!DELTA ENERGY}
{\it Value:} 0.01
...
{\it Description:}[Standard]  Interval size of energy spectrum (in eV), for DOS, PDOS and LDOS calculation.
...
{\it Description:} [Standard] Enables ground-state solve for SPIN POLARIZED case reading the SPIN UNPOLARIZED density from the checkpoint files, and use the TOTAL MAGNETIZATION to compute the spin up and spin down densities. This option is only valid for CHK TYPE=2 and RESTART FROM CHK=true. Default false.
...
{\it Possible values:} A floating point number $v$ such that $-1e-12 \leq v \leq 100$
